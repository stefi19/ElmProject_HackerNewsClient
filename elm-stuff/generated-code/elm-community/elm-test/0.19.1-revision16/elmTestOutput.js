...
var $author$project$Model$Light = {$: 'Light'};
...
var $author$project$Model$initModel = function (config) {
	return {
		...
		theme: $author$project$Model$Light
	};
};
...
var $author$project$Model$PostIds$advance = function (_v0) {
	...
	return A2(
		...
		function (newIds) {
			return _Utils_Tuple2(
				$author$project$Cursor$current(newIds),
				$author$project$Model$PostIds$PostIds(newIds));
		},
		$author$project$Cursor$forward(ids));
};
...
var $author$project$Model$Post$decode = function () {
	var urlDecoder = $elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2(
	...
	return A8(
		...
		F7(
			function (by, id, score, title, url, time, typeStr) {
				return {
					by: by,
					id: id,
					score: score,
					time: $elm$time$Time$millisToPosix(time * 1000),
					title: title,
					type_: typeStr,
					url: url
				};
...
var $author$project$Cursor$fromList = function (x) {
	if (!x.b) {
		return $elm$core$Maybe$Nothing;
	} else {
		var y = x.a;
		var ys = x.b;
		return $elm$core$Maybe$Just(
			A3($author$project$Cursor$withSelectedElement, _List_Nil, y, ys));
	}
};
	...
	function (msg, model) {
		if (msg.$ === 'ToggleTheme') {
			var newTheme = function () {
				var _v1 = model.theme;
				if (_v1.$ === 'Light') {
					return $author$project$Model$Dark;
				} else {
					return $author$project$Model$Light;
				}
			}();
			return _Utils_Tuple2(
				_Utils_update(
			...
			var _v2 = function () {
				var _v3 = _Utils_Tuple2(model.state, msg);
				_v3$7:
				while (true) {
					switch (_v3.a.$) {
						case 'LoadedPosts':
							if (_v3.b.$ === 'ConfigChanged') {
								var state = _v3.a.a;
								var change = _v3.b.a;
						...
						case 'LoadingPosts':
							switch (_v3.b.$) {
								case 'GotPost':
									...
									if (result.$ === 'Ok') {
										var post = result.a;
										var _v7 = $author$project$Model$PostIds$advance(loading.postIds);
										if (_v7.$ === 'Just') {
											var _v8 = _v7.a;
											var nextId = _v8.a;
											var nextPostIds = _v8.b;
								...
								case 'ConfigChanged':
									var loading = _v3.a.a;
									var change = _v3.b.a;
									var newConfig = A2($author$project$Model$PostsConfig$applyChanges, change, loading.config);
									return _Utils_Tuple2(
										$author$project$Model$LoadingPosts(
											_Utils_update(
												loading,
						...
						case 'Loading':
							switch (_v3.b.$) {
								case 'GotPostIds':
									var config = _v3.a.a.config;
									var time = _v3.a.a.time;
									var result = _v3.b.a;
									if (result.$ === 'Ok') {
										if (result.a.$ === 'Just') {
											var ids = result.a.a;
								...
								case 'ConfigChanged':
									...
									return _Utils_Tuple2(
										$author$project$Model$Loading(
											{
												config: A2($author$project$Model$PostsConfig$applyChanges, change, config),
												time: time
											}),
										$author$project$Effect$NoEffect);
								default:
...
var $author$project$Model$PostsConfig$SetPostsToShow = function (a) {
	return {$: 'SetPostsToShow', a: a};
};
...
var $author$project$Util$Time$durationBetween = F2(
	function (t1, t2) {
		...
		if (totalSeconds <= 0) {
			...
			var days = (totalSeconds / secondsInDay) | 0;
			var remAfterDays = totalSeconds - (days * secondsInDay);
			var hours = (remAfterDays / 3600) | 0;
			var remAfterHours = remAfterDays - (hours * 3600);
			var minutes = (remAfterHours / 60) | 0;
			var seconds = remAfterHours - (minutes * 60);
			return $elm$core$Maybe$Just(
...
var $author$project$Model$PostsConfig$filterPosts = F2(
	function (config, posts) {
		var postsAfterTextFilter = config.showTextOnly ? posts : A2(
			$elm$core$List$filter,
			function (t) {
				return !_Utils_eq(t.url, $elm$core$Maybe$Nothing);
			},
			posts);
		var postsAfterJobFilter = config.showJobs ? postsAfterTextFilter : A2(
			$elm$core$List$filter,
			function (t) {
				return t.type_ !== 'job';
			},
			postsAfterTextFilter);
		var limited = A2($elm$core$List$take, config.postsToShow, postsAfterJobFilter);
		var sortedLimited = function () {
...
var $author$project$Util$Time$formatDuration = function (dur) {
	var part = F3(
		function (n, singular, plural) {
			return (!n) ? $elm$core$Maybe$Nothing : ((n === 1) ? $elm$core$Maybe$Just(
				$elm$core$String$fromInt(n) + (' ' + singular)) : $elm$core$Maybe$Just(
				$elm$core$String$fromInt(n) + (' ' + plural)));
		});
	var parts = A2(
		...
		_List_fromArray(
			[
				A3(part, dur.days, 'day', 'days'),
				A3(part, dur.hours, 'hour', 'hours'),
				A3(part, dur.minutes, 'minute', 'minutes'),
				A3(part, dur.seconds, 'second', 'seconds')
			]));
	var body = function () {
		if (!parts.b) {
			return '0 seconds';
...
var $author$project$View$Posts$postTable = F3(
	function (config, now, postsList) {
		var totalCount = $elm$core$List$length(postsList);
		var row = function (post) {
			var visibleTime = A2($author$project$Util$Time$formatTime, $elm$time$Time$utc, post.time);
			var urlCell = function () {
				var _v0 = post.url;
				if (_v0.$ === 'Just') {
					var u = _v0.a;
					return A2(
			...
			var relative = A2(
				...
				A2(
					...
					A2($author$project$Util$Time$durationBetween, post.time, now)));
			return A2(
				$elm$html$Html$tr,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$title(relative)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(visibleTime),
								(relative === '') ? $elm$html$Html$text('') : $elm$html$Html$text(' (' + (relative + ')'))
							])),
						A2(
						$elm$html$Html$td,
						_List_fromArray(
		...
		var filteredPosts = A2($author$project$Model$PostsConfig$filterPosts, config, postsList);
		var shownCount = $elm$core$List$length(filteredPosts);
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$tbody,
							_List_Nil,
							A2($elm$core$List$map, row, filteredPosts))
						])),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$id('posts-controls')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
							'Showing ' + ($elm$core$String$fromInt(shownCount) + (' of ' + ($elm$core$String$fromInt(totalCount) + ' posts')))),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick(
									$author$project$Model$ConfigChanged(
										$author$project$Model$PostsConfig$SetPostsToShow(config.postsToShow + 10)))
								]),
							_List_fromArray(
								[
...
var $author$project$Model$PostsConfig$ChangeTODO = {$: 'ChangeTODO'};
var $author$project$Model$PostsConfig$SetShowJobs = function (a) {
	return {$: 'SetShowJobs', a: a};
};
var $author$project$Model$PostsConfig$SetShowTextOnly = function (a) {
	return {$: 'SetShowTextOnly', a: a};
};
var $author$project$Model$PostsConfig$SetSortBy = function (a) {
...
var $author$project$View$Posts$postsConfigView = function (config) {
	var sortOptionsView = A2(
		$elm$core$List$map,
		function (fmt) {
			var str = $author$project$Model$PostsConfig$sortToString(fmt);
			return A2(
	...
	var postsOptions = _List_fromArray(
		[10, 25, 50]);
	var postsOptionsView = A2(
		$elm$core$List$map,
		function (n) {
			return A2(
				$elm$html$Html$option,
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$selected(
						_Utils_eq(n, config.postsToShow))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						A2(
							...
							A2(
								$elm$core$Basics$composeR,
								$elm$core$Maybe$map($author$project$Model$PostsConfig$SetPostsToShow),
								A2(
									$elm$core$Basics$composeR,
									$elm$core$Maybe$withDefault($author$project$Model$PostsConfig$ChangeTODO),
									$author$project$Model$ConfigChanged))))
					]),
				postsOptionsView),
				A2(
				...
				_List_fromArray(
					[
						...
						A2(
							...
							A2(
								$elm$core$Basics$composeR,
								$elm$core$Maybe$map($author$project$Model$PostsConfig$SetSortBy),
								A2(
									$elm$core$Basics$composeR,
									$elm$core$Maybe$withDefault($author$project$Model$PostsConfig$ChangeTODO),
									$author$project$Model$ConfigChanged))))
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($elm$core$Basics$composeR, $author$project$Model$PostsConfig$SetShowJobs, $author$project$Model$ConfigChanged))
							]),
						_List_Nil),
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onCheck(
								A2($elm$core$Basics$composeR, $author$project$Model$PostsConfig$SetShowTextOnly, $author$project$Model$ConfigChanged))
							]),
						_List_Nil),
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Model$ToggleTheme)
					]),
				_List_fromArray(
					[
...
var $author$project$Main$view = function (model) {
	...
	var themeStyle = function () {
		...
		if (_v2.$ === 'Light') {
			return _List_fromArray(
				[
					_Utils_Tuple2('background-color', '#ffffff'),
					_Utils_Tuple2('color', '#111111')
				]);
		} else {
			return _List_fromArray(
				[
					_Utils_Tuple2('background-color', '#0b0b0b'),
					_Utils_Tuple2('color', '#e6e6e6')
				]);
		}
	}();
	var body = function () {
			...
			case 'FailedToLoad':
				...
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							'Failed to load: ' + $author$project$Main$httpErrorToString(err))
						]));
			case 'LoadedPosts':
				var config = _v1.a.config;
				var time = _v1.a.time;
				var posts = _v1.a.posts;
				return A2(
					$elm$html$Html$div,
					_List_Nil,
					_List_fromArray(
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/Users/stefi/Desktop/Projects/Elm-Project/tests/ExampleTests/CursorTests.elm', '/Users/stefi/Desktop/Projects/Elm-Project/tests/ExampleTests/ModelPostIdsTests.elm', '/Users/stefi/Desktop/Projects/Elm-Project/tests/ExampleTests/ModelPostsConfigTests.elm', '/Users/stefi/Desktop/Projects/Elm-Project/tests/ExampleTests/UtilTimeTests.elm', '/Users/stefi/Desktop/Projects/Elm-Project/tests/MainTests.elm', '/Users/stefi/Desktop/Projects/Elm-Project/tests/PostTests.elm', '/Users/stefi/Desktop/Projects/Elm-Project/tests/PostsConfigTests.elm', '/Users/stefi/Desktop/Projects/Elm-Project/tests/PostsViewTests.elm', '/Users/stefi/Desktop/Projects/Elm-Project/tests/SimulatedEffect.elm', '/Users/stefi/Desktop/Projects/Elm-Project/tests/TestData.elm', '/Users/stefi/Desktop/Projects/Elm-Project/tests/TestUtils.elm']),
		processes: 10,
...
var pipeFilename = "/tmp/elm_test-42282.sock";
var net = require('net'),
